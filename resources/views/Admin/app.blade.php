...
<div class="container-fluid">
    ...
    <input type="hidden" name="csrf_test_name" value="e497dd0a1a9094182772f204029c6079" />                            
    <input type="hidden" name="setting_id" value="1" style="display:none;" />
                                ...
                                <!-- if setting favicon is already uploaded -->
                                    ...
                                    <div class="col-sm-9">
                                        <img src="https://phpcryptomarket.bdtask.com/demo-v4.0/public/uploads/dashboard/new/1609072784_bafaefb632fe55203bc9.png" alt="Favicon" class="img-thumbnail" />
                                    </div>
                                </div>
                                ...
                                <!-- if setting logo is already uploaded -->
                                    ...
                                    <div class="col-sm-9">
                                        <img src="https://phpcryptomarket.bdtask.com/demo-v4.0/public/uploads/settings/1609072784_a3d6ceb248256f995c1e.png" alt="Picture" class="img-thumbnail" />
                                    </div>
                                </div>
                                ...
                                <!-- if setting Web logo is already uploaded -->
                                    ...
                                    <label for="logoPreview" class="col-sm-3 col-form-label"></label>
                                    <div class="col-sm-9">
                                        <img src="https://phpcryptomarket.bdtask.com/demo-v4.0/public/uploads/settings/1609072784_296695c381fe8874cc5f.png" alt="Picture" class="img-thumbnail" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="hidden" name="old_web_logo" value="/public/uploads/settings/1609072784_296695c381fe8874cc5f.png">
    ...
    <option value="french">French</option>
                                ...
                                <div class="form-group row">
                                    <label for="time_zone" class="col-sm-3 col-form-label">Time Zone  <i class="text-danger">*</i></label>
                                    <div class="col-sm-9">
                                        <select id="time_zone" name="time_zone" class="form-control">
                                            <option value="">Select Option</option>
                                                                                        ...
                                                                                        <option value="Africa/Douala" selected>Africa/Douala</option>";
                                ...
                                <div class="form-group row">
                                    ...
                                    <label class="col-form-label ">For Payout</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="copyed1" value="curl --request GET https://phpcryptomarket.bdtask.com/demo-v4.0/customer/auto_commission/payout" readonly>
                                    ...
                                    <div class="col-form-label col-sm-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="copyed2" value="curl --request GET https://phpcryptomarket.bdtask.com/demo-v4.0/backend/currency/Currency_cronjob" readonly>
                                            <span class="input-group-btn">
