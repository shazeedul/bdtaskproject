            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                <div class="text-center">
                    <img src="../../dist/img/user4-128x128.jpg" class="avatar img-circle img-thumbnail" alt="avatar">
                    <h6>Upload a different photo...</h6>
                    <input type="file" class="text-center center-block file-upload">
                </div>

                <h3 class="profile-username text-center">Syed Shazeedul Islam</h3>
                  ...
                  <div class="tab-pane" id="settings">
                    ...
                    <form class="form-horizontal" method="POST" action="{{route('adminprofile')}}">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="password" class="form-control" name="#" id="password2" placeholder="confirm password" title="enter your confirm password.">
                        </div>
                      </div>
                      <div class="form-group row">
