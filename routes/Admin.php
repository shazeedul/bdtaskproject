...
Route::post('/contact_us', 'App\Http\Controllers\Admin\CmsController@updateContact')->name('contactus');
...
Route::post('/app_settings', 'App\Http\Controllers\Admin\AppsettingsController@update')->name('appsettings');
...
Route::get('/subscriber', 'App\Http\Controllers\Admin\TicketController@subscriber')->name('subscriber');
